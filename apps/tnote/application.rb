...
module Tnote
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['TNOTE_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Tnote::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Tnote::Action is included
      ...
      # Configure the code that will yield each time Tnote::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Tnote::Assets::Helpers
      end
    end
