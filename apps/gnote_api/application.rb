...
module GnoteApi
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['GNOTE_API_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load GnoteApi::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time GnoteApi::Action is included
      ...
      # Configure the code that will yield each time GnoteApi::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include GnoteApi::Assets::Helpers
      end
    end
