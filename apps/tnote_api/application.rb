...
module TnoteApi
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['TNOTE_API_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load TnoteApi::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time TnoteApi::Action is included
      ...
      # Configure the code that will yield each time TnoteApi::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include TnoteApi::Assets::Helpers
      end
    end
